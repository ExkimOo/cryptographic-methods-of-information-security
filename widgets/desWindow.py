...
class Ui_DES(object):
    def setupUi(self, DES):
        ...
        self.cypherName = QtWidgets.QLabel(DES)
        ...
        self.type = QtWidgets.QComboBox(DES)
        ...
        self.type.addItem("")
        self.type.addItem("")
        self.progressBar = QtWidgets.QProgressBar(DES)
        ...
        self.timeSpentText = QtWidgets.QLabel(DES)
                    ...
                    match self.mode.currentText():
                        ...
                        case 'CBC':
                            ...
                            while (text := file_input.read(8)):
                                text_bin = bitarray.bitarray()
                                text_bin.frombytes(text)
                                vect = self.des.encrypt(text_bin ^ vect, key_bin)
                        ...
                        case 'CFB':
                            ...
                            while (text := file_input.read(8)):
                                text_bin = bitarray.bitarray()
                                text_bin.frombytes(text)
                                vect = self.des.encrypt(vect, key_bin) ^ text_bin
                                file_output.write(vect.tobytes())
                        ...
                        case 'OFB':
                            ...
                            while (text := file_input.read(8)):
                                text_bin = bitarray.bitarray()
                                text_bin.frombytes(text)
                                vect = self.des.encrypt(vect, key_bin)
                    ...
                    match self.mode.currentText():
                        case 'ECB':
                            while (text := file_input.read(8)):
                                text_bin = bitarray.bitarray()
                                text_bin.frombytes(text)
                                file_output.write(self.des.decrypt(text_bin, key_bin).tobytes())
                        ...
                        case 'CBC':
                            ...
                            while (text := file_input.read(8)):
                                text_bin = bitarray.bitarray()
                                text_bin.frombytes(text)
                                file_output.write((vect ^ self.des.decrypt(text_bin, key_bin)).tobytes())
                                vect = text_bin
                        ...
                        case 'CFB':
                            ...
                            while (text := file_input.read(8)):
                                text_bin = bitarray.bitarray()
                                text_bin.frombytes(text)
                                file_output.write((self.des.encrypt(vect, key_bin) ^ text_bin).tobytes())
                                vect = text_bin
    ...
    def getPath(self, obj):
        path = QFileDialog.getOpenFileName()[0]
        if path[-3:] != 'des':
            self.outputFilePath.setText(path + '.des')
        else:
    ...
    def retranslateUi(self, DES):
        ...
        self.writeInputToFileButton.setText(_translate("DES", "Записать в файл"))
        self.readInputFromFileButton.setText(_translate("DES", "Считать из файла"))
        self.writeOutputToFileButton.setText(_translate("DES", "Записать в файл"))
        self.readOutputFromFileButton.setText(_translate("DES", "Считать из файла"))
        ...
        self.writeKeyToFileButton.setText(_translate("DES", "Записать ключ в файл"))
        self.readKeyFromFileButton.setText(_translate("DES", "Считать ключ из файла"))
        ...
        self.inputFileText.setText(_translate("DES", "Входной файл  "))
        self.inputFilePathButton.setText(_translate("DES", "Указать путь"))
        self.outputFileText.setText(_translate("DES", "Выходной файл"))
        self.outputFilePathButton.setText(_translate("DES", "Указать путь"))
        ...
        self.type.setItemText(0, _translate("DES", "Текст"))
        self.type.setItemText(1, _translate("DES", "Файл"))
        self.timeSpentText.setText(_translate("DES", "Прошло"))
